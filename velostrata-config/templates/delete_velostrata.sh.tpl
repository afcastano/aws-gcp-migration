...
gcloud compute instances list | grep 'velostrata-edge\|wordpress' | awk '{printf "gcloud compute instances delete %s --zone %s -q \n", $1, $2}' | bash 
echo Deleting addresses ... 
gcloud compute addresses list | grep 'velostrata-edge\|wordpress' | awk '{printf "gcloud compute addresses delete %s --region %s -q \n", $1, $5}' | bash 
